...
export const AdminDashboardPage = () => {
    ...
    const fetchAdminData = async () => {
        ...
        try {
            ...
            // Referrals (Safe fetch to preserve visual tab even if logic is removed)
            try {
                const { data: referralRes, error: refErr } = await supabase
                    .from('referrals')
                ...
                console.warn("Referral data fetch skipped or failed.");
            }
