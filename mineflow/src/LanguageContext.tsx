...
const translations = {
  en: {
    ...
    dashboard: { welcome: 'Overview', last_login: 'Last active', deposit_bal: 'Wallet Balance', earning_bal: 'Withdrawable Profit', deposit: 'Add Funds', withdraw: 'Withdraw', reinvest: 'Reinvest', transfer: 'Transfer', active_plans: 'Active Miners', total_earnings: 'Total Profit', my_ref: 'Referral Link', copy: 'Copy', view_investments: 'My Miners', available_plans: 'Buy New Miner', recent_tx: 'Transaction History', no_tx: 'No recent activity' },
  ...
  pt: {
    ...
    dashboard: { welcome: 'Resumo', last_login: 'Ativo', deposit_bal: 'Saldo Carteira', earning_bal: 'Lucro Disponível', deposit: 'Adicionar Fundos', withdraw: 'Sacar', reinvest: 'Reinvestir', transfer: 'Transferir', active_plans: 'Mineradores Activos', total_earnings: 'Lucro Total', my_ref: 'Link de Indicação', copy: 'Copiar', view_investments: 'Meus Mineradores', available_plans: 'Novo Minerador', recent_tx: 'Histórico', no_tx: 'Sem atividade recente' },
